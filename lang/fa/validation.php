...
return [
    ...
    */
    ...
    'validate_password' => 'گذرواژه قبلی نادرست می باشد.',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'attributes' => [
        ...
        'national_code' => 'کدملی',
        'mcode' => 'کدملی',
        'verify_id' => 'شماره شناسنامه ',
        'born_city' => 'محل تولد',
        'registration_number' => 'شماره ثبت',
        'economic_code' => 'کد اقتصادی',
        'registration_ad' => 'اگهی ثبت',
        'last_published_ad' => 'آخرین اگهی رسمی',
        'agent_letterpic' => 'نامه معرفی نماینده',
        'permissions_id' => 'سطح دسترسی',
        'meta_title' => 'سطح دسترسی',
        'expire' => 'تاریخ انقضا',
        'show' => 'وضعیت نمایش',
        'role_id' => 'نقش',
        'service_id' => 'سرویس',
